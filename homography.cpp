...
int main( int argc, char** argv )
{
  ...
  std::cout << descriptors_object.size() << std::endl << descriptors_scene.size() << std::endl;
  ...
  cv::Mat rotMatrix;
  cv::Mat tvect;
  decomposeProjectionMatrix(H, cam_array, rotMatrix, tvect);
  std::cout << "Cam" << cam_array << " Rotation = " << rotMatrix << " Translation = " << tvect << std::endl;
*/
  waitKey(0);
  return 0;
  }
